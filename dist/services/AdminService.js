...
var AdminService = /*#__PURE__*/function (_Service) {
  _inherits(AdminService, _Service);
  var _super = _createSuper(AdminService);
  function AdminService(model) {
  ...
  _createClass(AdminService, [{
          ...
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              return _context.abrupt("return", {
                error: true,
                message: "User is not found with this  ".concat(item.email, " address"),
                statusCode: 404,
                data: null
              });
            case 6:
    ...
    key: "changePassword",
    value: function () {
      var _changePassword = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req) {
        var _req$body, currentPassword, newPassword, id, user, isPasswordValid, hash, updatedUser;

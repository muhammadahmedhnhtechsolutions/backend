...
var menuService = new _MenuService["default"](new _MenuModel["default"]().getModel());
var MenuController = /*#__PURE__*/function (_Controller) {
  _inherits(MenuController, _Controller);
  var _super = _createSuper(MenuController);
  function MenuController(service) {
    ...
    _this.getAllAdminMenu = _this.getAllAdminMenu.bind(_assertThisInitialized(_this));
    ...
    _this.UpdateAllmenu = _this.UpdateAllmenu.bind(_assertThisInitialized(_this));
    _this.getAdminRestaurantMenu = _this.getAdminRestaurantMenu.bind(_assertThisInitialized(_this));
  ...
  _createClass(MenuController, [{
    key: "dataUpdate",
    value: function () {
      var _dataUpdate = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
        var response;
    ...
    key: "createMenu",
    value: function () {
      var _createMenu = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
        var response;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return this.service.createMenu(req, res);
            case 2:
    ...
    key: "insertCsvData",
    value: function () {
      var _insertCsvData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
        var response;
      ...
      function insertCsvData(_x5, _x6) {
    ...
    key: "addReview",
    value: function () {
      var _addReview = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
        var response;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return this.service.addReview(req, res);
            case 2:
    ...
    value: function () {
      console.log(1)
      var _getAllMenu = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return this.service.getAllMenu(req.query);
            case 2:
    ...
    key: "getAllAdminMenu",
    value: function () {
      var _getAllAdminMenu = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
        var response;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              _context6.next = 2;
              return this.service.getAllAdminMenu2(req.query);
            case 2:
      ...
      function getAllAdminMenu(_x11, _x12) {
    ...
    key: "getSingleMenu",
    value: function () {
      var _getSingleMenu = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
        var id, response;
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              id = req.params.id;
              _context7.next = 3;
              return this.service.getSingleMenu(id);
            case 3:
      ...
      function getSingleMenu(_x13, _x14) {
    ...
    value: function () {
      var _getRestaurantMenu = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
        var response;
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              _context8.next = 2;
              return this.service.getRestaurantMenu(req.query, req.user);
            case 2:
      ...
      function getRestaurantMenu(_x15, _x16) {
    ...
    value: function () {
      var _getAdminRestaurantMenu = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(req, res) {
        var restaurantId, response;
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              restaurantId = req.params.restaurantId;
              _context9.next = 3;
              return this.service.getAdminRestaurantMenu(req.query, restaurantId);
            case 3:
      ...
      function getAdminRestaurantMenu(_x17, _x18) {
    ...
    key: "UpdateAllmenu",
    value: function () {
      var _UpdateAllmenu = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(req, res) {
        var response;
        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            case 0:
              _context10.next = 2;
              return this.service.UpdateAllmenu(req);
            case 2:
      ...
      function UpdateAllmenu(_x19, _x20) {
...
var _default = new MenuController(menuService);
